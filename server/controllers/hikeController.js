...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      let result;
      if (startType == "hut")
        result = await hikeHutService.linkHutAsStartEndToHike(hikeId, startId, true, undefined);
      if (endType == "hut")
        result = await hikeHutService.linkHutAsStartEndToHike(hikeId, endId, undefined, true);
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      let result;
      result = await hikeHutService.linkHutToHike(hikeId, hutId);
