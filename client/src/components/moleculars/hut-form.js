  ...
  const handleSubmit = (event) => {
    ...
    API.newHut(formData)
      .then(() => {
        ...
        navigate("/my-huts", { state: { message: "Hut inserted succefully" } });
      })
      .catch(() => {
        setSuccess("no");
      });
            ...
            <Row className="align-items-center pt-2">
              <Col>
                <Form.Group>
                  ...
                  <Form.Control
                    isInvalid={numberBeds === null || numberBeds < 0}
                    type="number"
                    placeholder="number of beds"
                    value={numberBeds == null ? "" : numberBeds}
                    onChange={(event) => {
                      setNumberBeds(event.target.value);
                    }}
                  />
                  <Form.Control.Feedback type="invalid">
              ...
              <Col md className="align-items-center"></Col>
            </Row>

            <Form.Group>
              <Form.Label>Phone *</Form.Label>
              <Form.Control
                isInvalid={phone === null || phone < 0}
                type="text"
                placeholder="phone"
